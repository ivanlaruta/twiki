                    ...
                    <div class="col-lg-5">
                        <div class="skills">
                            <ul class="list-group list-group-flush">
                                ...
                                <p class="sub"><a href="javascript:;" onclick="generar('pr_venta');" class="list-group-item list-group-item-action asd">Procedimientos del área de Ventas<span class="icon" style="float: right;"><i class="icofont icofont-long-arrow-right"></i></span></a></p>                           
                           
                                <p class="sub"><a href="javascript:;" onclick="generar('pr_importa');" class="list-group-item list-group-item-action asd">Procedimientos del área de Importaciones/Operaciones<span class="icon" style="float: right;"><i class="icofont icofont-long-arrow-right"></i></span></a></p>                           
                                ...
                                <p class="sub"><a href="javascript:;" onclick="generar('pr_prod_plan');" class="list-group-item list-group-item-action asd">Procedimientos del área Producto y Planificación<span class="icon" style="float: right;"><i class="icofont icofont-long-arrow-right"></i></span></a></p>                           
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-lg-4">
                            ...
                            <a href="javascript:;">
                                ...
                                <h6>Procedimientos área Analisis Comercial</h6>
                            </a>
                            </div>
                        </div> --}}
                        <div class="col-lg-4">
                            ...
                            <a href="javascript:;">
                                ...
                                <h6>Procedimientos del área de Ventas</h6>
                            </a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <a href="javascript:;">
                                ...
                                <h6>Procedimientos del área de Importaciones/Operaciones</h6>
                            </a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <div class="item" onclick="generar('pr_prod_plan');">
                            <a href="javascript:;">
                                <span class="icon"><i class="icofont icofont-pixels"></i></span>
                                <h6>Procedimientos del área Producto y Planificación</h6>
                            </a>
                            </div>
                        </div>
                      {{--   <div class="col-lg-4">
                    ...
                    <div class="col-lg-5">
                        <div class="skills">
                            ...
                            <ul class="list-group list-group-flush">
                                    ...
                                    <p class="sub"><a href="javascript:;" onclick="generar();" class="list-group-item list-group-item-action asd">Funcionalidad Tablet<span class="icon" style="float: right;"><i class="icofont icofont-long-arrow-right"></i></span></a></p>                                
                               
                                    <p class="sub"><a href="javascript:;" onclick="generar();" class="list-group-item list-group-item-action asd">Funcionalidad Web<span class="icon" style="float: right;"><i class="icofont icofont-long-arrow-right"></i></span></a></p>                                
            ...
            <div class="container">
                ...
                <div class="row contenido" id='pr_venta'>
                    ...
                    <div class="content col-sm-12">
                        <ul class="list-group list-group-flush">
                            ...
                            <a href="manuales/procedimientos/ventas/5. Procedimiento de Ventas en ferias o Activaciones 1.1.pdf" download="5. Procedimiento de Ventas en ferias o Activaciones 1.1.pdf" class="list-group-item list-group-item-action">
                            5. Procedimiento de Ventas en ferias o Activaciones 1.1.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                ...
                <div class="row contenido" id='pr_importa'>
                     <div class="section-head col-sm-12">
                        <h4 style="font-size: 22px;">
                            <span>PROCEDIMIENTOS</span><br>
                            IMPORTACIONES / OPERACIONES
                        </h4>
                    </div>
                    <div class="content col-sm-12">
                        <ul class="list-group list-group-flush">
                            
                            <a href="manuales/procedimientos/importaciones/5. Procedimiento de traslado de Vehículos para ferias.pdf" download="5. Procedimiento de traslado de Vehículos para ferias.pdf" class="list-group-item list-group-item-action">
                            5. Procedimiento de traslado de Vehículos para ferias.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                ...
                <div class="row contenido" id='pr_finanzas'>
                    ...
                    <div class="content col-sm-12">
                        <ul class="list-group list-group-flush">
                            ...
                            <a href="manuales/procedimientos/finanzas/2. Procedimiento - Emisión de Orden de Pago.pdf" download="2. Procedimiento - Emisión de Orden de Pago.pdf" class="list-group-item list-group-item-action">
                            2. Procedimiento - Emisión de Orden de Pago.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>

                            <a href="manuales/procedimientos/finanzas/3. Procedimiento - Control de Boletas de Garantía.pdf" download="3. Procedimiento - Control de Boletas de Garantía.pdf" class="list-group-item list-group-item-action">
                            3. Procedimiento - Control de Boletas de Garantía.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>

                            <a href="manuales/procedimientos/finanzas/4. Procedimiento - Previsión por obsolescencia de Repuestos y o Accesorios.pdf" download="4. Procedimiento - Previsión por obsolescencia de Repuestos y o Accesorios.pdf" class="list-group-item list-group-item-action">
                            4. Procedimiento - Previsión por obsolescencia de Repuestos y o Accesorios.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>

                            <a href="manuales/procedimientos/finanzas/5. Procedimiento - Previsiones para incobrables.pdf" download="5. Procedimiento - Previsiones para incobrables.pdf" class="list-group-item list-group-item-action">
                            5. Procedimiento - Previsiones para incobrables.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                ...
                <div class="row contenido" id='pr_prod_plan'>
                     <div class="section-head col-sm-12">
                        <h4 style="font-size: 22px;">
                            <span>PROCEDIMIENTOS</span><br>
                    ...
                    <div class="content col-sm-12">
                        <ul class="list-group list-group-flush">
                            ...
                            <a href="manuales/procedimientos/producto_plan/1. Procedimiento - Registro de especificaciones técnicas de vehículos.pdf" download="1. Procedimiento - Registro de especificaciones técnicas de vehículos.pdf" class="list-group-item list-group-item-action">
                            1. Procedimiento - Registro de especificaciones técnicas de vehículos.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                            <a href="manuales/procedimientos/producto_plan/2. Procedimiento - Creación y modificacion de másters.pdf" download="2. Procedimiento - Creación y modificacion de másters.pdf" class="list-group-item list-group-item-action">
                            2. Procedimiento - Creación y modificacion de másters.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                            <a href="manuales/procedimientos/producto_plan/3. Procedimiento - Pedido a proveedores.pdf" download="3. Procedimiento - Pedido a proveedores.pdf" class="list-group-item list-group-item-action">
                            3. Procedimiento - Pedido a proveedores.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                            <a href="manuales/procedimientos/producto_plan/4. Procedimiento - Registro de precios.pdf" download="4. Procedimiento - Registro de precios.pdf" class="list-group-item list-group-item-action">
                            4. Procedimiento - Registro de precios.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                            <a href="manuales/procedimientos/producto_plan/5. Procedimiento - Análisis del Mercado.pdf" download="5. Procedimiento - Análisis del Mercado.pdf" class="list-group-item list-group-item-action">
                            5. Procedimiento - Análisis del Mercado.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
                            <a href="manuales/procedimientos/producto_plan/6. Procedimiento - Análisis de precios de la competencia.pdf" download="6. Procedimiento - Análisis de precios de la competencia.pdf" class="list-group-item list-group-item-action">
                            6. Procedimiento - Análisis de precios de la competencia.pdf <span class="icon" style="float: right;"><i class="icofont icofont-download-alt"></i></span>
                            </a>
